...
1 **Sistema**:
    ...
    - Tras realizar paso 5 - Activar crontab para ejecución automática del Script de Sincronización de datos.
        - Abrimos terminal
...
4 **Sincronización de datos y mapeo**:
...
5 **Tratamiento de datos en servidor**:
